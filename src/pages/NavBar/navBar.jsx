...
export default function Navbar(){
    return(
        <header className="Nav-Container">
            ...
            <ul>
                <li><a href="https://www.linkedin.com/in/joaovictorst/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                ...
                <li><a href="https://github.com/joaovictorst" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                  <path fill="none" d="M0 0h24v24H0z"></path>
